...
const BackgroundImage = ({
  ...
  return (
    <div className="relative block">
      ...
      >
        <p className="font-sans xl:text-3xl sm:text-2xl text-xl font-regular">
          {category}
        </p>
        ...
        <Link href={"/shop"}>
          <button className="bg-light text-black rounded-md px-[4rem] py-[0.5rem] w-fit font-sans text-lg font-regular hover:bg-button-primary-focused-hover hover:text-light">
            Shop now
          </button>
        </Link>
      </div>
